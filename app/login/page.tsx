    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 flex-col items-center justify-center bg-gradient-to-br from-[#0f0f0f] to-[#1a1a1a] p-8">
        <div className="max-w-md text-center">
          ...
          />
          <h1 className="text-4xl font-bold text-text-primary mb-4">Nyumbani Greens</h1>
          ...
          <div className="space-y-4">
            <div className="flex items-start gap-3">
              ...
              <p className="text-text-secondary">Track Product Orders from sourcing through production</p>
            </div>
            <div className="flex items-start gap-3">
              <div className="w-1 h-1 rounded-full bg-harvest-gold mt-2 flex-shrink-0"></div>
              <p className="text-text-secondary">Real-time inventory management and cost tracking</p>
            </div>
            <div className="flex items-start gap-3">
              <div className="w-1 h-1 rounded-full bg-nyumbani-green mt-2 flex-shrink-0"></div>
              <p className="text-text-secondary">Seamless Zoho sales integration for end-to-end traceability</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="w-full lg:w-1/2 flex flex-col items-center justify-center px-6 py-12 bg-background">
        <div className="w-full max-w-md">
          ...
          <div className="lg:hidden mb-8 text-center">
            ...
            />
            <h1 className="text-2xl font-bold text-text-primary">Nyumbani Greens</h1>
          </div>

          <h2 className="text-2xl font-bold text-text-primary mb-2 text-center lg:text-left">
            Welcome Back
          </h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              ...
              <p className="mt-2 text-xs text-text-muted">
                Demo: demo@nyumbani.com, manager@nyumbani.com, or operator@nyumbani.com
              </p>
            </div>
          ...
          <div className="mt-8 pt-8 border-t border-border">
            <p className="text-center text-sm text-text-muted">
              ...
              <Link href="/" className="text-nyumbani-green hover:text-nyumbani-green/80 font-medium">
                Back to Home
              </Link>
            </p>
          </div>
          ...
          <div className="mt-8 p-4 bg-neutral-900 border border-nyumbani-green/20 rounded-lg">
            <p className="text-xs font-semibold text-nyumbani-green mb-3">DEMO ACCOUNTS</p>
            <div className="space-y-2 text-xs">
              ...
              <div className="border-t border-border pt-2">
                <p className="font-mono text-text-primary">manager@nyumbani.com</p>
                <p className="text-text-muted">Password: manager123 (Manager)</p>
              </div>
              <div className="border-t border-border pt-2">
                <p className="font-mono text-text-primary">operator@nyumbani.com</p>
                <p className="text-text-muted">Password: operator123 (Operator)</p>
              </div>
            </div>
          </div>
        </div>
